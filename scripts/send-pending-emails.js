...
async function main() {
  try {
    ...
    for (const doc of snap.docs) {
      ...
      try {
        // Allow overriding the sender display via SENDER_EMAIL env var; fallback to default address
        const sender = process.env.SENDER_EMAIL || 'Team Process Wizard <no-reply@tpw.com>';
