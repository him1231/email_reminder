  ...
  return (
    <DndContext
      ...
      onDragEnd={async (e)=>{
        ...
        // prevent cycles
        if (wouldCreateCycle(items.map(i=>({ id:i.id, parentId: i.parentId })), active, newParentId)) {
          // do not perform move if it would create a cycle
          // eslint-disable-next-line no-console
          console.warn('Move prevented to avoid creating a cycle', { active, newParentId });
          return;
        }
